...
public class HomeController {
	...
	public ModelAndView redirectURI(@RequestParam( required=true,name ="code") String code, HttpSession httpSession) {
	...
	/**
	 * @param instaHttpCurlService the instaHttpCurlService to set
	 */
